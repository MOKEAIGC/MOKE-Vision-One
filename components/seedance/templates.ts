...
Visual control: coherent lighting, physically plausible movement, stable identity.`,
  ...
  },
  {
    ...
    mode: '全素材参考',
    assets: [
      { name: '@video1', description: '待延展的源片段' },
      { name: '@image1', description: '风格/细节锚点' }
    ],
    prompt: `Extend @video1 by 5s. Keep continuity of character identity, outfit, camera direction, and lighting.
...
Audio: continue ambience; add subtle transition swell only at climax.`,
    negative: 'no watermark, no logo.',
    settings: { duration: '5秒 (延展)', aspectRatio: '原比例' }
  },
  {
    id: 'C',
    name: '角色替换',
    mode: '全素材参考',
    assets: [
      { name: '@video1', description: '基础编舞和镜头' },
      { name: '@image1', description: '替换角色的身份参考' }
    ],
    prompt: `Replace the main performer in @video1 with the character from @image1.
...
Keep scene composition and lighting style; maintain clean edge blending and stable identity in all frames.`,
    negative: 'no watermark, no logo, no text.',
    settings: { duration: '原视频时长', aspectRatio: '原比例' }
  },
  {
    id: 'D',
    name: 'IP 安全原创生物对战（纯文本，10 秒）',
    mode: '纯文本生成',
    assets: [],
    prompt: `vertical 9:16, 10s, 24fps, family-friendly original cartoon fantasy duel in a sunset forest clearing, vibrant cinematic lighting, expressive faces, smooth animation, high detail
...
7-10s: both land safely, smile, and perform a friendly team pose on two rocks under a glowing orange-pink sky, uplifting finish`,
    negative: 'no existing franchise characters, no brand references, no logos, no watermark, no subtitles, no on-screen text, no violence, no injuries',
    settings: { duration: '10 秒', aspectRatio: '9:16', fps: '24fps' }
  },
  {
    id: 'E',
    name: 'IP 安全科幻英雄（纯文本，10 秒）',
    mode: '纯文本生成',
    assets: [],
...
7-10s: Alloy Sentinel lands safely on a skybridge, energy core shifts from bright to calm glow, Orbit Mentor drone hovers at shoulder height, both face sunrise over the city, hopeful heroic ending`,
    negative: 'no Marvel, no Iron Man, no Tony Stark, no Avengers, no arc reactor, no franchise references, no logos, no recognizable character likeness, no watermark, no subtitles, no on-screen text',
    settings: { duration: '10 秒', aspectRatio: '9:16', fps: '24fps' }
  },
  {
    id: 'F',
    name: '玩偶舞蹈动画（全素材参考，10 秒）',
    mode: '全素材参考',
    assets: [
      { name: '@image1', description: '玩偶角色的身份、颜色、服装形态、比例（仅保留玩偶/街舞的一般美学，不保留任何品牌标识）' }
    ],
    prompt: `9:16 vertical, 10s, stylized toy dance animation in a clean studio set, one original vinyl-style toy figure performing an upbeat hip-hop routine, playful and family-friendly tone, smooth animation, clean silhouette readability, soft cinematic lighting, simple gradient backdrop, energetic music-video framing
...
7-10s: final combo, short forward glide, hand-point to camera, confident freeze pose, slight camera tilt and gentle punch-in for final beat`,
    negative: 'no real person likeness, no celebrity likeness, no branded toy, no logos, no trademark symbols, no text on clothing, no watermark, no subtitles, no violent gestures, no broken joints, no extra limbs, no deformed hands, no flicker, no blur, no face distortion',
    settings: { duration: '10 秒', aspectRatio: '9:16', style: '玩偶街舞，干净棚拍，合家欢' }
  },
  {
    id: 'G',
    name: 'MV 节拍同步蒙太奇',
    mode: '全素材参考',
    assets: [
      { name: '@image1-4', description: '视觉素材组' },
      { name: '@video1', description: '节拍结构和剪辑节奏参考' },
      { name: '@audio1', description: '配乐时间参考' }
    ],
    prompt: `Create a 12s montage synced to @audio1 beat accents, using @video1 rhythm style.
...
Maintain consistent color grade and dynamic but readable composition.`,
    negative: 'no watermark, no logo.',
    settings: { duration: '12 秒', aspectRatio: '原比例' }
  },
  {
    id: 'H',
    name: '产品展示 / 电商广告（10 秒）',
...
Material rendering: accurate surface finish, glass reflections, metallic sheen where applicable`,
  ...
  },
  {
    ...
    mode: '全素材参考',
    assets: [
      { name: '@image1', description: '主角外观（首帧）' },
      { name: '@image2', description: '配角外观' }
    ],
    prompt: `9:16 vertical, 15s, cinematic short drama scene, indoor office setting, warm tungsten lighting with cool window backlight, shallow depth of field, emotionally charged atmosphere
...
Sound: paper hitting floor, score resolves to silence, faint city ambience`,
    negative: 'no watermark, no subtitles, no on-screen text, no jump cuts, no shaky cam',
    settings: { duration: '15 秒', aspectRatio: '9:16' }
  },
  {
    id: 'J',
    name: '一镜到底 + 多图航点（15 秒）',
    ...
    assets: [
      { name: '@image1', description: '主角外观（首帧）' },
      { name: '@image2', description: '巷角建筑参考' },
      { name: '@image3', description: '神秘人物外观' },
      { name: '@image4', description: '目标建筑外观' }
    ],
    prompt: `16:9 widescreen, 15s, espionage thriller style, continuous one-take tracking shot, no cuts, rainy evening, neon-reflected wet streets, suspenseful atmosphere
...
Single continuous camera movement throughout, no cuts, no montage`,
    negative: 'no watermark, no subtitles, no on-screen text, no jump cuts, no freeze frames',
    settings: { duration: '15 秒', aspectRatio: '16:9' }
  },
  {
    id: 'K',
    name: '多段拼接长视频（>15 秒，30 秒示例）',
    mode: '多段拼接',
    assets: [
      { name: '@video1', description: '第 1 段的输出视频（生成后上传，用于第 2 段）' }
    ],
    prompt: `## 第 1 段（0-15 秒）—— 正常生成
...
11-15s: sword master lands gracefully, sheathes blade, residual golden particles drift in the air, camera slow push-in on profile against clearing sky, score fades to wind ambience`,
    negative: 'no watermark, no on-screen text',
    settings: { duration: '约 30 秒 (分2段)', aspectRatio: '16:9' },
    notes: '第 1 段：正常生成（≤15 秒），以干净的交接帧收束。第 2 段+：上传前段输出作为 @video1，写 延展 @video1 X 秒，包含连续性说明。'
  }
];
